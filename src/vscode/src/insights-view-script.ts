/**
 * Browser-side behavior for the insights webview.
 */

import { HELP_SCRIPT, renderHelpButton } from './help';
import type { InsightsPayload } from './insights';

export function renderInsightsBrowserScript(payload: InsightsPayload): string {
