...
updatedAt: 2026-07-07T03:49:35.812Z
---
...
- [ ] Details panel width can be resized with a visible drag affordance
- [ ] Resizing has sensible minimum and maximum widths across supported viewport sizes
- [ ] Details panel includes a close button that dismisses the current panel
- [ ] Clicking a board task after dismissal reopens the details panel for that task
- [ ] Panel state does not cause task cards, columns, or toolbar controls to overlap
- [ ] Keyboard and screen-reader behavior remains usable for opening and closing details
- [ ] Tests cover resizing, closing, reopening, and layout persistence or reset behavior
