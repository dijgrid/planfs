# PlanFS 1.4 Release Notes (Release Candidate)
...
- VS Code content/diagnostic views, reversible workspace-scoped suggestion dismissal, and a confirmed, explained Apply path for a small set of safely mapped metadata suggestions;
