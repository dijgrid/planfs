...
- [ ] CLI lists commits, timestamps, authors, and subjects for an entity
- [ ] History follows active-to-archive moves and reports when continuity cannot be proven
- [ ] A selected revision can show a readable metadata/body change summary
- [ ] VS Code exposes history from task, epic, milestone, and decision surfaces
- [ ] No history or activity files are written under `.planfs`
- [ ] Behavior is clear for shallow clones, missing Git, uncommitted files, and renamed artifacts
- [ ] Tests use isolated Git repositories and cover modification, archive move, rename, and deletion
